...
![tools](https://skillicons.dev/icons?i=linux,nix,vscode,unity)

![tools](https://skillicons.dev/icons?i=git,github,docker,kubernetes)

### Experienced in

#### General

![lang](https://skillicons.dev/icons?i=v,cs,java,kotlin)

![lang](https://skillicons.dev/icons?i=python,bash)

#### Web

![web1](https://skillicons.dev/icons?i=js,ts,nodejs,react)

![web2](https://skillicons.dev/icons?i=html,css,mui,tailwind)
